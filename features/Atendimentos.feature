...
Scenario: O dentista precisa filtrar todos os atendimentos pelo CPF do paciente.
	...
	And Eu requisito o sistema para "filtrar"
	Then Eu vejo uma lista com o atendimento de nome do paciente, CPF do paciente, tipo, data, hora, nome do dentista com os valores "João Asfora Silva, 987654321-98, consulta, 09-03-2020, 10:59, Karlos Gubianni"
